...
const favoriteThings ={
  ...
  food: 'Gumbo',
  person: 'wife',
  book: 'C++ Programming and Design 7th Ed.',
  movie: 'The Matrix',
  holiday: 'Festivus'
}
...
function makeCard(cardNumber, expirationDate, securityCode){
  let Credit_Card = new Object();
  Credit_Card.cardNumber = this.cardNumber;
  Credit_Card.expirationDate = this.expirationDate;
  Credit_Card.securityCode = this.securityCode;
  return Credit_Card;
}